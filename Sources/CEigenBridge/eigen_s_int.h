...
#ifndef eigen_s_int_h
#define eigen_s_int_h
...
void eigen_s_int_set_entries(void *a, int_t *rows, int_t *cols, int_t *values, int_t count);
...
void eigen_s_int_copy_nz(void *a, int_t *rows, int_t *cols, int_t *values);
